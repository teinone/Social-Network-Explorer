...
# Add an extra source|target column into the table, used for graph aggregation
dt.reddit.subset.time$sourcetarget <- str_c(df.reddit.subset.time$SOURCE_SUBREDDIT,
                                            "|",
                                            df.reddit.subset.time$TARGET_SUBREDDIT)

dt.reddit.master <- dt.reddit.subset.time


# Add an extra source-target column into the table
...
#==============================================================================
#Save all to .RData
save(dt.reddit.ferguson, dt.reddit.obama, dt.reddit.orlando, dt.reddit.trump, file = "dt.reddit.events.RData")
#==============================================================================
# Drop tables
rm(dt.reddit.master)

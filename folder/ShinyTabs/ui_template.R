...
shinyUI(
  dashboardPage(
    ...
    dashboardBody(
      theme_blue_gradient,
      tabItems(
            tabItem(tabName = "welcome",                     # Here we define a new
              fluidRow(
                box(
      ...
      tabItem(tabName = "orlando",                     
              fluidRow(
                box(
                  title = "Event overview", width = "100%",
                  tabsetPanel(type = "tabs", 
                              # Histogram
                              tabPanel("No. of posts over time", plotOutput("plotName"),
                                       p("Please  input summary here, and insert graph above."), 
                                       p("Remember to set graph width = '100%'")
                                       ),# end of tabPanel
                              # Tiffany's compound graph
                              tabPanel("Sentiment analysis I", verbatimTextOutput("summary"),
                                       p("Please  input summary here, and insert graph above."), 
                                       p("Remember to set graph width = '100%'")
                                       ),# end of tabPanel
                              # Lizzie's sentiment distribution graph
                              tabPanel("Sentiment analysis II", tableOutput("table"),
                                       p("Please  input summary here, and insert graph above."), 
                                       p("Remember to set graph width = '100%'")
                                       ),# end of tabPanel
                              # Minxin's graph
                              tabPanel("Sentiment analysis III", plotOutput("plotName"),
                                       p("Please  input summary here, and insert graph above."), 
                                       p("Remember to set graph width = '100%'")
                                       ),#end of tabPanel
                              # Subreddit network
                              tabPanel("Subreddit network", plotOutput("plotName"),
                                       p("Please  input summary here, and insert graph above."), 
                                       p("Remember to set graph width = '100%'")
                                       ),#end of tabPanel
                              # Degree distribution
                              tabPanel("Degree distribution", plotOutput("plotName"),
                                       p("Please  input summary here, and insert graph above."), 
                                       p("Remember to set graph width = '100%'")
                                       )#end of tabPanel
